...
\quad
\tilde{p} = \begin{bmatrix} 1 & 3 \\ 3 & 1 \end{bmatrix}
\implies
a = \begin{bmatrix} 1/2 & 1/2 \end{bmatrix},
\quad
p = \begin{bmatrix} 1/4 & 3/4 \\ 3/4 & 1/4 \end{bmatrix}
$$
...
4. if $P(O | \lambda)$ increases by some threshold, and max iterations has
   not been reached, repeat from step 2
